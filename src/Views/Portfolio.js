				...
				<div className="row row-cols-2 row-cols-md-1 row-cols-lg-1">
					<div classNanme="col">
						<div className="alert alert-secondary alert-dismissible w-75 center mb-5">
							<strong>Coming soon!</strong> In the near future, you'll be able
										...
										<div
											...
											<div className="card-body m-2">
												...
												<div className="card-text mb-3 list-group-item-text1 text-start">
													...
													user guide. After reviewing the application's
													requirements and specifications, I outlined tha
													manuals and completed the final drafts when the client
													signed off on quality assurance. I then delivered the
													manuals to the user acceptance testing leads for
													testing and documentationa signoff.
												</div>
											</div>
										</div>
									</div>
									...
									<div className="carousel-caption d-none d-md-block">
										<div
											...
											<div className="card-body m-2">
												...
												<div className="card-text mb-3 list-group-item-text1 text-start">
													For a custom implementation of cost accounting
													software, I was asked to consolidate a third-party
										...
										<div
											...
											<div className="card-body m-2">
												...
												<div className="card-text mb-3 list-group-item-text1 text-start">
													...
													user-centered design, I worked as a help desk team
													lead. The support staff, myself included, often
													reported that keyword searching in the incident
													reporting system was...well, not good. I designed
													these storyboards to demonstrate how a centralized
													intranet site could improve efficiency and user
													satisfaction, by storing our policies and procuedures

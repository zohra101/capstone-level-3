					...
					<div className="carousel-inner">
						<div
							...
							<div className="carousel-caption d-none d-md-block">
								...
								<p>
									...
									each application into an administrator guide and a user guide.
									I outlined the guides after reviewing the application's
						...
						<div
							...
							<div className="carousel-caption d-none d-md-block">
								...
								<p>
									While in graduate schoool specializing in user-centered
									design, I worked as a help desk team lead. The support staff,
									myself included, often reported that keyword searching in the
									incident reporting system was...well, not good. I designed
									these storyboards to demonstrate how a centralized intranet
									site could improve efficiency and user satisfaction, by
									storing our policies and procuedures and by providing a robust
									searchable knowlesge base.
								</p>
							</div>
						</div>
					</div>

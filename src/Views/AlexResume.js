				...
				<div className="container ms-0">
					...
					<div className="row">
						<div className="col">
							...
							<p>
								<span id="skill">Project Management: </span>Asana, Jira,
								Microsoft Project; SQL Server Management Studio, SQL Server
								Reporting Services (SSRS), Team Foundation Server (TFS), Test
					...
					<div className="row">
						<div className="col">
							...
							<ul>
								...
								<li>
									Researched a help desk knowledge management system and
					...
					<div className="row">
						...
						<h4>
							{" "}
							Nivedana Consulting/Freelancer (Remote) | Nov 2014 – Present
						</h4>
						<p>Blurb</p>
						<ul className="ms-5">
							<li>
							...
							<li>
								Penned 17 best of, how-to, and review articles on Android and
								iOS apps for a web magazine.
							</li>
							<li>
								Implemented communication standards on a wellness company
								website by composing privacy policy, translating content, and
								managing ISO code data.
							</li>
						</ul>
						<h3>Consultant</h3>
						<h4>
						...
						<ul className="ms-5">
							<li>
								...
								modernization project by adhering to style guides, advocating
								for end users, performing usability testing, and researching
								trends.
							</li>
							<li>
								Supplemented documentation by developing security diagrams,
								editing release notes and technical specifications, and
								clarifying functionality for end user training.
							</li>
							<li>
								Reduced user story errors by creating a Jira template, training
								business analysts on best practices, and creating priority
								lists. Produced 300+ user stories in 2.5 years.
							</li>
						</ul>
						<h3>Business Analyst/Technical Writer</h3>
						<h4>
							<a href="https://www.dbsysgraph.com/">DB Sysgraph</a> (Baton
							Rouge, LA) | Oct 2018 – Jul 2021
						</h4>
						<p>Blurb</p>
						<ul className="ms-5">
							<li>
							...
							<li>
								...
								developing close relationships with the client’s CTO and
								industry experts by creating storyboards, specifications, test
								plans, and workshops.
							</li>
							<li>
								Designed a clean and easy to use interface to automate
								collection of complex data for export to a federal agency.
								Promoted from Quality Assurance to Business Analyst after only 6
								months.
							</li>
						</ul>
						...
						<ul className="ms-5">
							<li>
								...
								management committee. Partnered with delivery managers to
								analyze gaps, and drafted 1st versions of best practices,
								policies, and procedures.
							</li>
							<li>
								Engaged IT management to define configuration and security
								policy, executing 1st projects using new API.
							</li>
							<li>
						...
						<ul className="ms-5">
							<li>
								...
								Recruited by business systems portfolio manager after producing
								a 300-page manual and other training materials as side projects.
							</li>
							<li>
								Improved documentation management by maintaining a SharePoint
								catalog of specifications for 800+ business intelligence
								reports. Designed templates for requirements, specifications,
								test plans, and user guides to improve documentation usability.
							</li>
							<li>
